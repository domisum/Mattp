...
public final class MattpGetUtil
{
	...
	// STRING
	@API
	public static Optional<String> getString(AbstractURL url)
	{
		return getStringResponse(url).getContent();
	}

	@API
	public static RequestResponse<String> getStringResponse(AbstractURL url)
	{
	...
	// BYTE ARRAY
	@API
	public static Optional<byte[]> getByteArray(AbstractURL url)
	{
		return getByteArrayResponse(url).getContent();
	}

	@API
	public static RequestResponse<byte[]> getByteArrayResponse(AbstractURL url)
	{
	...
	// IMAGE
	@API
	public static Optional<BufferedImage> getImage(AbstractURL url)
	{
		return getImageResponse(url).getContent();
	}

	@API
	public static RequestResponse<BufferedImage> getImageResponse(AbstractURL url)
	{
	...
	// GENERIC
	@API
	public static <T> RequestResponse<T> getResponse(AbstractURL url, MattpResponseBodyReader<T> responseBodyReader)
	{
	...
	@API
	public static <T> Optional<T> get(AbstractURL url, MattpResponseBodyReader<T> responseBodyReader)
	{
